# Business Portals Core Agent Context
...
- Package root: `framework/builtin-plugins/business-portals-core`
- Service layer: `framework/builtin-plugins/business-portals-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/business-portals-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/business-portals-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/business-portals-core/src/ui`

## Safe assumptions

- Use `business-portals-core` as the stable plugin identifier and `@plugins/business-portals-core` as the package import name.
