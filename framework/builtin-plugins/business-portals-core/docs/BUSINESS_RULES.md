# Business Portals Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `business-portals-core` and its owned resource set.
...
- ERP parity references are tracked against: `Portal`, `Support`, `Selling`, `Buying`.
