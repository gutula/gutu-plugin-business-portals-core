# Business Portals Core Mandatory Steps

## Before shipping a change

1. Update the public contract docs in `README.md` and `DEVELOPER.md`.
2. Keep the nested docs under `framework/builtin-plugins/business-portals-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `business-portals-core` and the package import `@plugins/business-portals-core`.
