...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Business Portals Control Room"),
    React.createElement("p", null, "Governed self-service workspaces, projected business data, and explicit portal-driven requests."),
    React.createElement(
      "p",
      null,
