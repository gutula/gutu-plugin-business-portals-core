...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/business-portals-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-business-portals-core:");
...
console.log("Documentation check passed for gutu-plugin-business-portals-core.");
